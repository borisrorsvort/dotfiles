...
Task(subagent_type="oh-my-claudecode:executor", model="auto/best-fast", prompt="Add type export for UserConfig")
Task(subagent_type="oh-my-claudecode:executor", model="auto/best-coding", prompt="Implement the caching layer for API responses")
Task(subagent_type="oh-my-claudecode:executor", model="auto/best-reasoning", prompt="Refactor auth module to support OAuth2 flow")
