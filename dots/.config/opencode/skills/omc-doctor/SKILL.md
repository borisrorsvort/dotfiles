...
`ai-slop-cleaner`, `ask`, `autopilot`, `autoresearch`, `cancel`, `configure-notifications`, `debug`, `deep-interview`, `deepinit`, `execute`, `external-context`, `hud`, `skillify`, `omc-doctor`, `omc-setup`, `plan`, `project-session-manager`, `ralph`, `ralplan`, `release`, `remember`, `research`, `review`, `self-improve`, `skill`, `team`, `trace`, `ultragoal`, `verify`, `visual-verdict`, `wiki`
